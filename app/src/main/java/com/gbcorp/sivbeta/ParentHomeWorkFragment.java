...
//    ParentHomeWorkFragment.GetHomeworkTask getHomeWorkDetail = new ParentHomeWorkFragment.GetHomeworkTask();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.parenthomework, container, false);
        hwDateText = (SearchView) view.findViewById(R.id.homeworkdate);
        hwDateText.setSubmitButtonEnabled(true);
        ParentHomeWorkFragment.GetHomeworkTask getHomeWorkDetailInitial = new ParentHomeWorkFragment.GetHomeworkTask();
        getHomeWorkDetailInitial.execute();
    ...
    private class GetHomeworkTask extends AsyncTask<String, Void, String> {
        @Override
...
//            setProgressPercent(progress[0]);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                String homeworkdate = firsthomeworkObj.getString("entrydate");
...
//                RemarksText.setText(remarks);
                ...
                hwlist=(ListView) getActivity().findViewById(R.id.homeworkListView);
                hwlist.setAdapter(new HomeWorkCustomAdapter(getActivity(),jsonArr));
            }
            catch (Exception e){
